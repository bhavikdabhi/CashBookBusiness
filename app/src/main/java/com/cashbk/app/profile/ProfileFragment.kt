...
import com.cashbk.app.partner.User
...
//                    binding.tvBadgeTier.text = user.membershipTier ?: "GOLD MEMBER"
    ...
    private suspend fun scanAndDownloadMigrationData(progressDialog: AlertDialog): Boolean = withContext(Dispatchers.IO) {
    ...
    private fun uploadMigratedFiles(googleAccount: GoogleSignInAccount) {
